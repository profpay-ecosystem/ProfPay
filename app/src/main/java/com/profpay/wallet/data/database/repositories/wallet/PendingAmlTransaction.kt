...
class PendingAmlTransactionRepoImpl
    ...
    constructor(
        ...
        override suspend fun markAsSuccessful(txId: String) = pendingAmlTransactionDao.markAsSuccessful(txId)

        override suspend fun markAsError(txId: String) = pendingAmlTransactionDao.markAsError(txId)
