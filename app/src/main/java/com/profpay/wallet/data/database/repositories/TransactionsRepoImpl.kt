...
class TransactionsRepoImpl
    ...
    constructor(
        ...
        override suspend fun isTransactionPending(txid: String): Boolean = transactionsDao.isTransactionPending(txid)
        ...
        override suspend fun isTransactionSuccessful(txid: String): Boolean = transactionsDao.isTransactionSuccessful(txid)

        override suspend fun deleteTransactionByTxId(txid: String) = transactionsDao.deleteTransactionByTxId(txid)
    }
